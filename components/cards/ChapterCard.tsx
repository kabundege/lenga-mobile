...
const ChapterCard = ({
  ...
  return (
    <PressableScale
      onPress={() =>
        router.push(
          `/lessons/chapters/${chapterId}/${chapterVideo ? "video" : "quiz"}`,
        )
      }
      ...
      <View style={styles.card}>
        <View style={styles.header}>
          <View style={globalStyles.w_80}>
            <TextBody variant="body1" color="secondary">
              Intambwe ya {chapter.order}
            </TextBody>
        ...
        <View style={[globalStyles.flex_col, globalStyles.gap_xs]}>
          <View
            style={[globalStyles.self_start, flexBetween, globalStyles.gap_xs]}
          >
